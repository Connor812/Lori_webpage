    ...
    <div class="admin-change-pwd-form">
        ...
        <div class="admin-change-pwd-section-wrapper">
            <div class="admin-change-pwd-section">
                <form action="includes/admin_change_username.inc.php" method="post">
                    <h2>Username:
            ...
            <div class="admin-change-pwd-section">
                <form action="includes/admin_change_pwd.inc.php" method="post">
                    <h2>Password:</h2>
                    ...
                    <input id="re-pwd-input" class="admin-input" type="password" name="re_pwd"
